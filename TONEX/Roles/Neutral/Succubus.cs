...
public sealed class Succubus : RoleBase, INeutralKiller
{
    ...
    public static bool CanBeCharmed(PlayerControl pc) => pc != null && (pc.GetCustomRole().IsCrewmate() || pc.GetCustomRole().IsImpostor()) && !pc.Is(CustomRoles.Charmed) && !pc.Is(CustomRoles.Believer);
